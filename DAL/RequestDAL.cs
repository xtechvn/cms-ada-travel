    ...
    public class RequestDAL : GenericService<Request>
    {
        ...
        public async Task<DataTable> GetPagingList(RequestSearchModel searchModel)
        {
            try
            {
                ...
                objParam[7] = new SqlParameter("@RequestNo", searchModel.RequestNo);
        ...
        public async Task<long> UpdateRequest(Request Model)
        {
            try
            {
                ...
                objParam[12] = new SqlParameter("@VoucherId", Model.VoucherId);
                objParam[13] = new SqlParameter("@VoucherName", Model.VoucherName);
                objParam[14] = new SqlParameter("@Amount", Model.Amount);
                objParam[15] = new SqlParameter("@Discount", Model.Discount);
        ...
        public async Task<RequestDetailModel> GetDetailRequest(long RequestId)
        {
            try
            {
