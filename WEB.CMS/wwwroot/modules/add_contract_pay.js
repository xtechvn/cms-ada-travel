...
var _contract_pay_create = {
    ...
    UpdateAmount: function (index, orderId) {
        ...
        for (var i = 0; i < listContractPayDetail.length; i++) {
            ...
            if (listContractPayDetail[i].amount !== undefined && listContractPayDetail[i].amount !== null
                ...
                if (i == index) {
                    $('#amount_order_' + listContractPayDetail[i].orderCode).val(_contract_pay_create.FormatNumberStr(listContractPayDetail[i].amount))
                }
            }
        }
        $('#total_amount_need_pay').html(_contract_pay_create.FormatNumberStr(totalAmount))
        //var amount = $('#amount').val()
    ...
    UpdateAmountService: function (serviceId) {
        ...
        $('#total_amount_need_pay').html(_contract_pay_create.FormatNumberStr(totalAmount))
        $('#amount').val(_contract_pay_create.FormatNumberStr(totalAmount))
    },
    GetDataByClientId: function (clientId, isEdit = false) {
        ...
        _contract_pay_create.GetListBankAccountDeepSeekTravel()
        if (contract_type === '1') {
            _contract_pay_create.GetOrderListByClientId(clientId, isEdit);
        }
        if (contract_type === '2') {
            _contract_pay_create.GetDepositListByClientId(clientId);
        }
    },
    GetDataBySupplierId: function (supplierId, isEdit = false) {
        ...
        _contract_pay_create.GetListBankAccountDeepSeekTravel(supplierId)
        if (contract_type !== null && contract_type !== '' && parseInt(contract_type) == contractpay_type_other) return
        if (parseInt(contract_type) === 3) {
            _contract_pay_create.GetServiceListBySupplierId(supplierId, isEdit);
        }
        if (parseInt(contract_type) === 4) {
            _contract_pay_create.GetServiceListBySupplierId(supplierId, isEdit, true);
        }
    },
    GetServiceListBySupplierId: function (supplierId, isEdit = false, isCommission = false) {
        ...
        $.ajax({
            ...
            success: function (result) {
                ...
                if (isCommission) {
                    _contract_pay_create.GenderSupplierCommissionTable(result, isEdit, true)
                } else {
                    _contract_pay_create.GenderSupplierRefundTable(result, isEdit)
                }
            }
        });
    },
    GenderSupplierRefundTable: function (result, isEdit) {
        ...
        for (var i = 0; i < result.data.length; i++) {
            ...
            $('#supplier-refund-relate-table').find('tbody').append(
                ...
                " <input type='checkbox' id='service_ckb_" + result.data[i].serviceCode + "' name='service_ckb' onclick='_contract_pay_create.OnCheckBoxService(" + i + ")'>" +
                ...
                "<td class='text-right' >" + _contract_pay_create.FormatNumberStr(result.data[i].totalAmount) + "</td>" +
                "<td class='text-right' >" + _contract_pay_create.FormatNumberStr(result.data[i].totalDisarmed) + "</td>" +
                "<td class='text-right'>" + _contract_pay_create.FormatNumberStr(result.data[i].totalNeedPayment) + "</td>" +
                "<td class='text-right' >" + "<input type='text' id='amount_service_" + result.data[i].serviceCode + "' class='background-disabled text-right' maxlength='15'  autocomplete='off' style='min-width: 100px;' disabled  onkeyup='_contract_pay_create.FormatNumberService(this);' onchange='_contract_pay_create.UpdateAmountService(" + result.data[i].serviceId + ")' >" + "</td>" +
                "</tr>"
            );
            ...
            if (isEdit) {
                ...
                setTimeout(function () {
                    $('#amount_service_' + index).val(_contract_pay_create.FormatNumberStr(payment))
        ...
        $('#supplier-refund-relate-table').find('tbody').append(
            ...
            "<td class='text-right' >" + _contract_pay_create.FormatNumberStr(totalAmount) + "</td>" +
            "<td class='text-right'>" + _contract_pay_create.FormatNumberStr(totalDisarmed) + "</td>" +
            "<td class='text-right' >" + _contract_pay_create.FormatNumberStr(totalNeedPayment) + "</td>" +
            "<td class='text-right' id='total_amount_need_pay'>0</td>" +
            "</tr>"
        );
        if (isEdit) {
            setTimeout(function () {
                $('#total_amount_need_pay').html(_contract_pay_create.FormatNumberStr(totalPayment))
                _contract_pay_create.OnCheckBoxService();
            }, 1000)
        }
    },
            ...
            success: function (result) {
                ...
                for (var i = 0; i < result.data.length; i++) {
                    $('#order-relate-table').find('tbody').append(
                        ...
                        "<td>" +
                        "<label class='check-list number'>" +
                        " <input type='checkbox' id='order_ckb_" + result.data[i].orderCode + "' name='order_ckb' onclick='_contract_pay_create.OnCheckBox(" + i + ");_contract_pay_create.AddToListDetail(" + i + ")'>" +
                        " <span class='checkmark'></span>" + (i + 1) +
                        "  </label>" +
                        "<td>" +
                        ...
                        "<td class='text-right' >" + _contract_pay_create.FormatNumberStr(result.data[i].totalDisarmed) + "</td>" +
                        "<td class='text-right'>" + _contract_pay_create.FormatNumberStr(result.data[i].totalNeedPayment) + "</td>" +
                        "<td class='text-right' >" + "<input type='text' id='amount_order_" + result.data[i].orderCode + "' class='background-disabled text-right' maxlength='15'  autocomplete='off' style='min-width: 100px;' disabled  onkeyup='_contract_pay_create.FormatNumberOrder(" + result.data[i].orderCode + ");' onchange='_contract_pay_create.UpdateAmount(" + i + "," + result.data[i].orderId + ")' >" + "</td>" +
                        "</tr>"
                    );
                    totalAmount += result.data[i].totalAmount
                    totalDisarmed += result.data[i].totalDisarmed
                    ...
                    if (isEdit) {
                        ...
                        let payment = result.data[i].payment
                        setTimeout(function () {
                            $('#amount_order_' + index).val(_contract_pay_create.FormatNumberStr(payment))
                        }, 1000)
                    }
                    if (result.data[i].isChecked) {
                        let index = result.data[i].orderCode
                ...
                _contract_pay_create.SetValueToOrderCodeInput()
            }
        });
    },
        ...
        if (orderCodeInput != null && orderCodeInput !== undefined && orderCodeInput !== '') {
            ...
            for (var i = 0; i < listContractPayDetail.length; i++) {
                if (listContractPayDetail[i].orderCode === orderCodeInput) {
                    $('#amount_order_' + orderCodeInput).val(_contract_pay_create.FormatNumberStr(listContractPayDetail[i].totalNeedPayment))
                    $('#amount').val(_contract_pay_create.FormatNumberStr(listContractPayDetail[i].totalNeedPayment))
                    $('#total_amount_need_pay').html(_contract_pay_create.FormatNumberStr(listContractPayDetail[i].totalNeedPayment))
                    break
                }
            }
        }
            ...
            success: function (result) {
                ...
                for (var i = 0; i < result.data.length; i++) {
                    $('#deposit-relate-table').find('tbody').append(
                        ...
                        "<td class='text-right'>" + _contract_pay_create.FormatNumberStr(result.data[i].price) + "</td>" +
                        "</tr>"
                    );
                ...
                $('#deposit-relate-table').find('tbody').append(
                    "<tr style='font-weight:bold !important;'>" +
                    "<td class='text-right' colspan='5'> Tổng </td>" +
                    "<td>" + _contract_pay_create.FormatNumberStr(totalAmount) + "</td>" +
                    "</tr>"
                );
    ...
    AddNewContractPay: function () {
        let validate = _contract_pay_create.Validate()
        if (!validate)
            return;
    ...
    OnChooseContractPayType: function () {
        ...
        if (contract_type !== null && contract_type !== '' && parseInt(contract_type) == contractpay_type_supplier_refund) {//thu tiền NCC hoàn trả
            ...
            //    _contract_pay_create.GetServiceListBySupplierId(supplier_id, isEdit);
            //}
            $('#amount').val()
        ...
        if (contract_type !== null && contract_type !== '' && parseInt(contract_type) == contractpay_type_supplier_commision) {//thu tiền hoa hồng NCC
            ...
            //var supplier_id = $('#supplier-select').val()
            //if (supplier_id !== null && supplier_id !== undefined && supplier_id !== '') {
            //    _contract_pay_create.GetServiceListBySupplierId(supplier_id, isEdit, true);
            //}
            $('#amount').val()
            $('#amount').attr('disabled', true)
            $('#amount').addClass('background-disabled')
    ...
    OnChooseContractPayTypeEdit: function (client_id, supplierId, employeeId, objectType) {
        ...
        if (contract_type !== null && contract_type !== '' && parseInt(contract_type) == contractpay_type_order) { // thu tiền đơn hàng
            ...
            if (client_id !== null && client_id !== undefined && client_id !== '') {
                _contract_pay_create.GetDataByClientId(client_id, true)
            }
            _contract_pay_create.GetListBankAccountDeepSeekTravel()
        }
        if (contract_type !== null && contract_type !== '' && parseInt(contract_type) == contractpay_type_deposit) {//thu tiền ký quỹ
        ...
        if (contract_type !== null && contract_type !== '' && parseInt(contract_type) == contractpay_type_supplier_refund) {//thu tiền NCC hoàn trả
            ...
            _contract_pay_create.GetListBankAccountDeepSeekTravel(supplierId)
            if (supplierId !== null && supplierId !== undefined && supplierId !== '') {
                _contract_pay_create.GetServiceListBySupplierId(supplierId, true)
            }
        }
        if (contract_type !== null && contract_type !== '' && parseInt(contract_type) == contractpay_type_supplier_commision) {//thu tiền hoa hồng NCC
            $('#divSupplier').show()
            ...
            _contract_pay_create.GetListBankAccountDeepSeekTravel(supplierId)
            if (supplierId !== null && supplierId !== undefined && supplierId !== '') {
                _contract_pay_create.GetServiceListBySupplierId(supplierId, true, true)
            }
        }
        if (contract_type !== null && contract_type !== '' && parseInt(contract_type) == contractpay_type_other) {//thu tiền khác
            $('#order-relate').hide()
            ...
            if (objectType == 1) {
                ...
                _contract_pay_create.GetListBankAccountDeepSeekTravel(client_id)
            }
            if (objectType == 2) {
                $('#divSupplier').show()
        ...
        _contract_pay_create.OnChoosePaymentType()
    },
    Close: function () {
    ...
    OnChoosePaymentType: function () {
        ...
        if (parseInt(pay_type) != 2) { //thanh toán tiền mặt
            ...
            //        supplierId = supplier[0]
            //    }
            //    _contract_pay_create.GetListBankAccountBySupplierID(supplier)
            //}
        }
    },
    ...
    OnCheckBox: function (index) {
                ...
                if (checked) {
                    ...
                    if (amount === null || amount === undefined || amount === '' || parseInt(amount) === 0) {
                        ...
                        if (totalNeedPayment <= 0) {
                            ...
                            $('#amount_order_' + listContractPayDetail[i].orderCode).val(_contract_pay_create.FormatNumberStr(totalNeedPayment))
                            _contract_pay_create.UpdateAmount(i, listContractPayDetail[i].orderId)
                        }
                    }
                    if (isSuccess)
        ...
        _contract_pay_create.GetTotalAmount(index)
        setTimeout(_contract_pay_create.AddItemToInput(), 500)
        //setTimeout(_contract_pay_create.RenderItemChecked(), 500)
    },
    OnCheckBoxService: function () {
            ...
            for (var i = 0; i < listServiceRefundDetail.length; i++) {
                ...
                if (checked) {
                    ...
                    if (amount === null || amount === undefined || amount === '' || parseFloat(amount) === 0) {
                        $('#amount_service_' + listServiceRefundDetail[i].serviceCode).val(_contract_pay_create.FormatNumberStr(listServiceRefundDetail[i].totalNeedPayment))
        ...
        $('#amount').val(_contract_pay_create.FormatNumberStr(totalAmountServiceInput))
        $('#total_amount_need_pay').html(_contract_pay_create.FormatNumberStr(totalAmountServiceInput))
    },
        ...
        if (contract_type !== null && contract_type !== '' && parseInt(contract_type) == contractpay_type_deposit) { // thu tiền ký quỹ
            for (var i = 0; i < listContractPayDetail.length; i++) {
                ...
                if (checked) {
                    ...
                    var amount = $('#amount_order_' + listContractPayDetail[i].orderCode).val()
                    if (amount === null || amount === undefined || amount === '' || parseInt(amount) === 0) {
                        $('#amount_order_' + listContractPayDetail[i].orderCode).val(_contract_pay_create.FormatNumberStr(listContractPayDetail[i].totalNeedPayment))
                    }
                } else {
                    $('#amount_order_' + listContractPayDetail[i].orderCode).attr('disabled', true)
                    $('#amount_order_' + listContractPayDetail[i].orderCode).addClass('background-disabled')
    ...
    OnCheckedOrder: function (isClearDate = false) {
        ...
        if (fromCreateDateStr != null && toCreateDateStr != null) {
            ...
            for (var d = fromDate; d <= toDate; d.setDate(d.getDate() + 1)) {
                listDate.push(_contract_pay_create.FormatDate(d));
            }
        }
        for (var i = 0; i < listContractPayDetail.length; i++) {
        ...
        setTimeout(_contract_pay_create.OnCheckBox(), 300)
    },
    RenderItemChecked: function () {
        ...
        for (var i = 0; i < listChecked.length; i++) {
            $('#order-relate-table').find('tbody').append(
                ...
                "<td>" +
                "<label class='check-list number'>" +
                " <input type='checkbox' id='order_ckb_" + listChecked[i].orderCode + "' name='order_ckb' onclick='_contract_pay_create.OnCheckBox(" + i + ");_contract_pay_create.AddToListDetail(" + i + ")'>" +
                ...
                "<td class='text-right' >" + _contract_pay_create.FormatNumberStr(listChecked[i].totalAmount) + "</td>" +
                "<td class='text-right' >" + _contract_pay_create.FormatNumberStr(listChecked[i].totalDisarmed) + "</td>" +
                "<td class='text-right'>" + _contract_pay_create.FormatNumberStr(listChecked[i].totalNeedPayment) + "</td>" +
                "<td class='text-right' >" + "<input type='text' id='amount_order_" + listChecked[i].orderCode + "' class='background-disabled text-right' maxlength='15'  autocomplete='off' style='min-width: 100px;' disabled  onkeyup='_contract_pay_create.FormatNumberOrder(" + listChecked[i].orderCode + ");' onchange='_contract_pay_create.UpdateAmount(" + i + "," + listChecked[i].orderId + ")' >" + "</td>" +
                "</tr>"
            );
        ...
        for (var i = 0; i < listUnChecked.length; i++) {
            $('#order-relate-table').find('tbody').append(
                ...
                "<td>" +
                "<label class='check-list number'>" +
                " <input type='checkbox' id='order_ckb_" + listUnChecked[i].orderCode + "' name='order_ckb' onclick='_contract_pay_create.OnCheckBox(" + i + ");_contract_pay_create.AddToListDetail(" + i + ")'>" +
                " <span class='checkmark'></span>" + (index) +
                "  </label>" +
                "<td>" +
                ...
                "<td class='text-right' >" + _contract_pay_create.FormatNumberStr(listUnChecked[i].totalAmount) + "</td>" +
                "<td class='text-right' >" + _contract_pay_create.FormatNumberStr(listUnChecked[i].totalDisarmed) + "</td>" +
                "<td class='text-right'>" + _contract_pay_create.FormatNumberStr(listUnChecked[i].totalNeedPayment) + "</td>" +
                "<td class='text-right' >" + "<input type='text' id='amount_order_" + listUnChecked[i].orderCode + "' class='background-disabled text-right' maxlength='15'  autocomplete='off' style='min-width: 100px;' disabled  onkeyup='_contract_pay_create.FormatNumberOrder(" + listUnChecked[i].orderCode + ");' onchange='_contract_pay_create.UpdateAmount(" + i + "," + listUnChecked[i].orderId + ")' >" + "</td>" +
                "</tr>"
            );
            index++
        }
        ...
        _contract_pay_create.AddItemToInput()
    },
    ...
    OnChangeAmount: function () {
        ...
        if (contract_type !== null && contract_type !== '' && parseInt(contract_type) == contractpay_type_order) { // thu tiền đơn hàng
            ...
            if (currentAmomunt < amountEdit) {
                ...
                $('#amount').val(_contract_pay_create.FormatNumberStr(amountEdit))
                return false;
            }
        }
    },
