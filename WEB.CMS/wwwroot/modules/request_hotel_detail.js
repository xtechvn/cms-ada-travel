$(document).ready(function () {
    ...
    //$("body").on('click', "#btn_summit_service_hotel", function () {
    //    var id = $('#booking_id').val();
    //    _request_hotel_detail.Summit();
    //    _request_hotel_detail.UpdateStatus(2, id);
    //});
...
var _request_hotel_detail = {
    ...
    Initialization: function (hotel_booking_id) {
        ...
        _request_hotel_detail.getcomment(Request_Id)
    ...
    Summit: function () {
        ...
        var voucher = $('#servicemanual-hotel-voucher').val() != undefined ? $('#servicemanual-hotel-voucher').val().replaceAll(',', '') : '0'
        ...
        var object_summit = {
            ...
            hotel: {
                ...
                amount: $('.service-manual-hotel-total-service-amount').text().replaceAll(',',''),
        ...
        $('.servicemanual-hotel-room-tr').each(function (index, item) {
            ...
            var obj_hotel_room = {
                ...
                number_of_adult: element.find('.servicemanual-hotel-NumberOfAdult').val(),
                number_of_child: element.find('.servicemanual-hotel-NumberOfChild').val(),
                number_of_infant: element.find('.servicemanual-hotel-NumberOfInfant').val(),
                is_room_available: element.find('.servicemanual-hotel-room-available').val(),
                package: []
            };
            element.find('.servicemanual-hotel-room-rates-code').each(function (index_2, item_2) {
    ...
    getcomment: function (id) {
        $.ajax({
            url: "/RequestHotelBooking/CommentRequest",
            type: "post",
