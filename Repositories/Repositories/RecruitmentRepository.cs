...
namespace Repositories.Repositories
{
    public class RecruitmentRepository : IRecruitmentRepository
    {
        ...
        public async Task SaveFanpageImagesAsync(long articleId, List<string> images)
        {
            ...
            await _RecruitmentDAL.SaveFanpageImagesAsync(articleId, processedImages);
        }


        public async Task<List<string>> GetFanpageImagesAsync(long articleId)
        {
            return await _RecruitmentDAL.GetFanpageImagesAsync(articleId);
        }
        ...
        {
            return await _RecruitmentDAL.getPinnedArticleByPostition(cate_id, category_name, position);
        }
