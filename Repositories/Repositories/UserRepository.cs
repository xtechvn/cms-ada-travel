    ...
    public class UserRepository : IUserRepository
    {
        ...
        public async Task<UserDetailViewModel> CheckExistAccount(AccountModel entity)
        {
            try
            {
                ...
                var _encryptPassword = "14e1b600b1fd579f47433b88e8d85291";
        ...
        public async Task<List<User>> GetListUserDepartById(List<int?> ids)
        {
            try
            {

                return await _UserDAL.GetByDepartmentIds(ids);
