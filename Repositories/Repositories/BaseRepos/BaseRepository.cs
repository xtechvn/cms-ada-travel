    ...
    public class BaseRepository
    {
        ...
        public BaseRepository(IHttpContextAccessor context, IOptions<DataBaseConfig> dataBaseConfig, IConfiguration configuration,IUserRepository _UserRepository)
        {
            ...
            try
            {
                ...
                {
                    LogHelper.InsertLogTelegram("BaseRepository - BaseRepository - Get From Redis: " + ex);
                ...
                {
                    LogHelper.InsertLogTelegram("BaseRepository - BaseRepository - Set Redis: " + ex);
            ...
            {
                LogHelper.InsertLogTelegram("BaseRepository - BaseRepository: " + ex);
